...
FOLDER=sprint-mn-install-script
...
clear
echo -e
echo -e "${PURPLE}      _/_/_/  _/_/_/    _/_/_/    _/_/_/  _/      _/  _/_/_/_/_/ ${NC}"
echo -e "${PURPLE}   _/        _/    _/  _/    _/    _/    _/_/    _/      _/      ${NC}"
echo -e "${PURPLE}    _/_/    _/_/_/    _/_/_/      _/    _/  _/  _/      _/       ${NC}"
echo -e "${PURPLE}       _/  _/        _/    _/    _/    _/    _/_/      _/        ${NC}"
echo -e "${PURPLE}_/_/_/    _/        _/    _/  _/_/_/  _/      _/      _/         ${NC}"
echo -e
echo -e
echo -e "${PURPLE}Welcome to SPRINT Masternode Install ${NC}"
echo -e
...
#### END TEST FOR VERSION
 ...
 #Deploy chain files
 clear
 echo -e "${YELLOW}Do you want me to download a copy of the blockchain (IF YOU CHOOSE NO SYNC CAN TAKE UP TO 24H)? [y/n]${NC}"
 echo -e
   read DOSETUP
 if [[ $DOSETUP =~ "y" ]] ; then
...
${PURPLE}A great Thanks to Twystidceed who wrote the core of this code and Niko82 for adaptation for Sprint${NC}"
